...
export const brands = [
  {
    ...
    logo: buildPath("assets/fabricants/Cailler.jpg")
  },
  {
    name: "Lindt",
    ...
    logo: buildPath("assets/fabricants/lindtsansfond.png")
  },
  {
    name: "Milka",
    ...
    logo: buildPath("assets/fabricants/Milka.png")
  },
  {
    name: "Toblerone",
    ...
    logo: buildPath("assets/fabricants/Toblerone.png")
  },
  {
    name: "Frey",
    ...
    logo: buildPath("assets/fabricants/Frey.png")
  },
  {
    name: "Suchard",
    ...
    logo: buildPath("/assets/fabricants/Suchard.png")
  },
  {
    name: "Camille Bloch",
    ...
    logo: buildPath("assets/fabricants/camillesansfond.png")
  }
];
...
export function initCarousel() {
  ...
  if (!carousel || !brandName || !creationDate || !anecdote) {
    console.error("Éléments du carrousel non trouvés dans le DOM");
    return;
  }
  ...
  brands.forEach((brand) => {
    ...
    img.onerror = function() {
      console.warn(`Image non trouvée: ${brand.logo}`);
      // Utiliser une image par défaut
      this.src = buildPath('assets/fabricants/placeholder.png');
    };
